...
myManageHook = composeAll [ isFullscreen            --> doFullFloat,
                         className =? "brave-browser" --> doShift myws2,
                         className =? "Thunar" --> doShift myws4,
                         className =? "Nautilus" --> doShift myws4,
                         className =? "code" --> doShift myws5,
                         -- manage Gimp toolbox windows
                         className =? "Gimp"  --> doShift myws6, -- may be "Gimp" or "Gimp-2.4" instead
                         (className =? "Gimp" <&&> fmap ("tool" `isSuffixOf`) role) --> doFloat,
                         className =? "Godot" --> doShift myws6,
                         className =? "file-roller" --> doShift myws4,
                         className =? "Aseprite" --> doShift myws6,
                         className =? "MPlayer" --> doFloat,
                         className =? "MPlayer" --> doShift myws8,
                         className =? "mpv" --> doFloat,
                         className =? "mpv" --> doShift myws8,
                         className =? "telegram-desktop" --> doShift myws7,
