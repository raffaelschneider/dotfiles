...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    [
    -- launch dmenu/starters
      ((modm,xK_p), spawn dmenuCall)
    , ((modShift,xK_p), spawn "gmrun")
    , ((modm,xK_o), spawn "/home/zara/.scripts/dmenu_finder")
    , ((modShift,xK_o), spawn "/home/zara/.scripts/dmenu_wallpaper")
    ...
    , ((modm,xK_m) , spawn "urxvt -e ncmpcpp"    )
    , ((modm,xK_u) , spawn "xfce4-screenshooter" )
    , ((modShift,xK_m)     , spawn "urxvt -e alsamixer"       )
    , ((modShift,xK_r) , spawn "killall dzen2; xmonad --recompile; xmonad --restart")
    -- Alsa Multimedia Control
    , ((0, xF86XK_AudioLowerVolume), spawn "/home/rasch/scripts/xm_volctl down"  )
    , ((0, xF86XK_AudioRaiseVolume), spawn "/home/rasch/scripts/xm_volctl up"    )
    , ((0, xF86XK_AudioMute), spawn "/home/rasch/scripts/xm_volctl toggle")
    -- Brightness Control
    , ((0, 0x1008ff03), spawn "xbacklight -dec 10")
    , ((0, 0x1008ff02), spawn "xbacklight -inc 10")
    , ((modm,xK_F1), spawn "/home/rasch/scripts/xm_dateshow")
    ]
    ++
...
myManageHook = manageDocks <+> composeAll
    ...
    , className =? "AbiWord"             --> doShift (myWorkspaces !! 4)
    , className =? "GNumeric"            --> doShift (myWorkspaces !! 4)
...
myLogHook h = dynamicLogWithPP $ defaultPP
    ...
    where icon1 = "^i(/home/rasch/.xmonad/icons/stlarch/tile.xbm)^ca()"
          icon2 = "^i(/home/rasch/.xmonad/icons/stlarch/monocle.xbm)^ca()"
          icon3 = "^i(/home/rasch/.xmonad/icons/stlarch/bstack.xbm)^ca()"
          icon4 = "^i(/home/rasch/.xmonad/icons/stlarch/monocle2.xbm)^ca()"
...
--
------------------------------------------------------------------------
-- Force particular workspace to second screen
------------------------------------------------------------------------
--myStartupHook = do
--    screenWorkspace 1 >>= flip whenJust (windows . W.view)
--    windows $ W.greedyView "5:V"
